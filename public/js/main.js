...
const sleepOutput = document.querySelector('.sleep-output');

sleepOutput.textContent = sleep.value;

sleep.addEventListener('input', () => sleepOutput.textContent = sleep.value);
